    ...
    <main className="flex-1 flex flex-col bg-brand-dark">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-400">Welcome to Velvet. What can I do for you?</p>
        </div>
      </div>
      ...
      <footer className="p-6">
        <div className="relative bg-brand-dark-secondary rounded-lg">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2">
            <Button variant="secondary" className="bg-gray-700/50 hover:bg-gray-600/50 text-gray-300">
              Attach
            </Button>
            <Button className="ml-2 bg-brand-red text-white hover:bg-red-700">
              Send
            </Button>
          </div>
        </div>
