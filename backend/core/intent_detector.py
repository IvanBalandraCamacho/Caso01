...
- CREATE_PROPOSAL  → Si el usuario quiere crear, generar o redactar una propuesta, documento, informe, reporte o similar.
...
def classify_intent(user_query: str):
    ...
    if "CREATE_PROPOSAL" in response:
